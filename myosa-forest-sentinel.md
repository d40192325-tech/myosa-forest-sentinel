...
title: Forest Sentinel – Low Power Intrusion Detection using MYOSA
...
tags:
  ...
  - security
---
> A low-power, camera-free intrusion detection system using MYOSA multisensor fusion.

## Acknowledgements

This project was developed using the MYOSA multisensor platform.
The authors acknowledge the MYOSA team for providing hardware and documentation support.

## Overview

Forest Sentinel is a low-power, neuromorphic-inspired intrusion detection system built using the MYOSA multisensor board.
...
environmental perturbations such as sudden artificial ligh, proximity changes and ground vibrations. These sparse, meaningful events are processed using simple thresholding and decision logic,
...
<p align="center">
  <img src="/blockdiagram.png" width="800"><br/>
  <i>MYOSA-based Forest Sentinel hardware setup</i>
</p>

<p align="center">
  <img src="/setup.png" width="800"><br/>
  <i>MYOSA-based Forest Sentinel hardware setup</i>
</p>

<p align="center">
  <img src="/dashboard_1.png" width="800"><br/>
  <i>System Idle during daytime</i>
</p>

<p align="center">
  <img src="/dashboard_2.png" width="800"><br/>
  <i>System Monitoring</i>
</p>

<p align="center">
  <img src="/dashboard_3.png" width="800"><br/>
